...
extension StringCasingExtension on String {
  String toTitleCase() {
    ...
    // Added 'G/F' explicitly for ground floor abbreviations
    const rareTerms = {
    ...
    return replaceAll(RegExp(' +'), ' ')
        ...
        .map((str) {
          ...
          // Check both the stripped word and the exact string
          if (rareTerms.contains(coreWord) || rareTerms.contains(upperStr)) {
            return upperStr;
          }

          // 2. Handle Mixed Codes (e.g., "(SW123)", "3B", "A1")
          // If a word contains BOTH letters and numbers, keep it uppercase.
          // This covers your (LLDDD) case.
